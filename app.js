...
const QUEST_TEXTS = [
  "Trouver 3 hooks pour tes futurs posts", "Répondre à tous les commentaires en attente", "Repérer un compte concurrent inspirant",
  "Étirer le dos et les épaules 2 minutes", "Boire un grand verre d'eau", "Écrire 5 titres de posts sans les publier",
  "Ranger ton bureau de travail", "Regarder 3 Reels de la concurrence", "Noter une idée de collab école/entreprise",
  "Faire une pause écran de 5 minutes", "Relire un post publié la semaine dernière et l'analyser", "Proposer un sujet de story à l'équipe",
  "Vérifier l'orthographe d'un post avant publication", "Marcher 5 minutes dehors", "Sauvegarder 2 idées dans la banque d'idées",
  "Respirer profondément pendant 1 minute", "Identifier un hashtag pertinent pour ta prochaine publication", "Nettoyer ton bureau numérique (fichiers, dossiers)",
  "Complimenter un·e collègue sur son travail", "Repérer une tendance TikTok transposable sur Instagram", "Faire 10 squats entre deux tâches",
  "Mettre à jour la bio Instagram ou LinkedIn si besoin", "Planifier un post dans le calendrier édito", "Étirer les poignets avant de taper",
  "Analyser le meilleur post du mois et pourquoi il a marché", "Écrire une légende alternative pour un post existant", "Sourire (oui, vraiment, ça compte)",
  "Repérer un étudiant à mettre en avant", "Vérifier les messages privés Instagram", "Faire une liste de 3 choses accomplies aujourd'hui",
  "Proposer un format vidéo jamais testé", "Ranger ta todo-list du jour", "Boire un café ou un thé en pleine conscience (pas devant l'écran)",
  "Ajouter un post inspirant à la banque d'idées", "Faire 5 minutes de tri dans tes photos de shooting", "Étirer les jambes sous le bureau",
  "Demander un feedback à un·e collègue sur un visuel", "Vérifier les stats du dernier post LinkedIn", "Fermer les onglets inutiles",
  "Repérer une story à republier en avant-premier", "Faire une pause sans téléphone pendant 5 minutes", "Écrire un post sur les coulisses de l'équipe",
  "Vérifier que le calendrier édito est à jour", "Étirer le cou doucement de chaque côté", "Identifier un partenaire potentiel pour une collab",
  "Relire les règles de la charte graphique EDO", "Boire de l'eau (encore, oui, c'est important)", "Repérer 2 comptes à suivre pour l'inspiration",
  "Faire une quête bien-être : sourire à un inconnu", "Ranger le dossier des visuels du mois", "Planifier une story avec un sondage",
  "Écrire un post sur un événement à venir", "Étirer les avant-bras après avoir écrit", "Vérifier les commentaires LinkedIn en attente",
  "Faire 1 minute de silence sans notifications", "Ajouter une idée de podcast ou d'interview étudiant", "Ranger ton espace de travail physique",
  "Repérer une citation inspirante à partager", "Marcher jusqu'à la fenêtre et regarder dehors 1 minute", "Écrire un post sur les valeurs d'EDO Campus",
  "Vérifier les liens dans la bio des réseaux", "Faire une quête bien-être : boire un thé chaud lentement", "Identifier un moment fort de la semaine à raconter",
  "Étirer les mollets debout 30 secondes", "Repérer un post ancien à recycler", "Nettoyer ta boîte mail des messages traités",
  "Faire 5 respirations profondes avant une réunion", "Écrire une accroche différente pour un post existant", "Ranger les fichiers du dernier shooting photo",
  "Repérer une story éphémère à transformer en post permanent", "Étirer les bras au-dessus de la tête", "Vérifier l'analytics Instagram de la semaine",
  "Faire une pause thé/café avec un·e collègue", "Écrire un post sur un métier peu connu enseigné à EDO", "Ranger ton bureau virtuel (icônes, fichiers)",
  "Repérer un hashtag EDO à réutiliser", "Étirer les chevilles assis 20 secondes", "Vérifier que les visuels respectent la charte graphique",
  "Faire une quête bien-être : marcher 10 minutes", "Écrire un post sur un succès d'ancien étudiant", "Ranger les dossiers partagés de l'équipe",
  "Repérer un post à forte interaction et en comprendre la raison", "Étirer le bas du dos en position debout", "Vérifier les DM LinkedIn en attente",
  "Faire 3 grands bâillements pour se détendre", "Écrire un post sur les coulisses d'un événement EDO", "Ranger les templates Canva utilisés",
  "Repérer une musique tendance pour un futur reel", "Étirer les trapèzes en haussant les épaules", "Vérifier la cohérence visuelle du feed Instagram",
  "Faire une pause de 2 minutes les yeux fermés", "Écrire un post FAQ sur une formation EDO", "Ranger les brouillons de posts non publiés",
  "Repérer un compte partenaire à taguer prochainement", "Étirer les doigts après avoir tapé longtemps", "Vérifier les objectifs du mois en cours",
  "Faire une quête bien-être : noter une gratitude du jour", "Écrire un post sur une astuce d'étudiant", "Ranger le calendrier de publication de la semaine",
  "Repérer un nouveau format de contenu à tester (carrousel, live, etc.)", "Étirer les épaules vers l'arrière 10 secondes", "Faire le point sur les quêtes de la semaine avec l'équipe"
];
